...
def seed_services():
    try:
        ...
        for s in [
            ...
            Service(service_name="Diagnosztika", cost=5000, tenant_id=tenant_id),
            Service(service_name="Legkond toltes", cost=12000, tenant_id=tenant_id),
            Service(service_name="Vezerlosziij csere", cost=35000, tenant_id=tenant_id),
            Service(service_name="Fekfolyadek csere", cost=6000, tenant_id=tenant_id),
        ...
        for p in [
            ...
            Part(part_name="Fekbetet keszlet elso", cost=8500, tenant_id=tenant_id),
            Part(part_name="Fekbetet keszlet hatso", cost=7200, tenant_id=tenant_id),
            Part(part_name="Gyujtogyertya db", cost=1800, tenant_id=tenant_id),
            Part(part_name="Uzemanyagszuro", cost=3200, tenant_id=tenant_id),
